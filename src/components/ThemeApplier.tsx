...
export function ThemeApplier() {
  ...
  const css = `:root{--background:${c.background};--surface:${c.surface};--surface-2:${c.surface2};--primary:${c.primary};--primary-dark:${c.primaryDark};--accent:${c.accent};--border:${c.primary}2e;}`;
