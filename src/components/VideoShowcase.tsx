...
const clips: ClinicVideo[] = clinic.videos && clinic.videos.length > 0 ? clinic.videos : defaultClips;
const intro = clinic.videosIntro ?? {
...
// Portrait reels look best in a centered row of phone-style cards.
    ...
    <section id="videos" className="relative overflow-hidden py-20 lg:py-28">
      ...
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        <Reveal className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-lg text-muted">{tr(intro)}</p>
        </Reveal>

        <div
          className={
            allPortrait
              ? "mx-auto mt-14 flex max-w-4xl flex-wrap justify-center gap-6 sm:gap-8"
              : "mx-auto mt-14 flex max-w-5xl flex-col gap-10"
          }
        >
          {clips.map((c, i) => {
